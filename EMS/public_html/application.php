        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading"><h4>Leaves</h4></div>
                        </br>
                    ...
                    <table class="table table-bordered">
                        ...
                        $apply = "SELECT * FROM application WHERE type='leaves' ORDER BY status='Pending' DESC";
                        ...
                        <tr>
                            ...
                            ?>
                            <td><a href="appDetails.php?app_ID=<?php echo $application['app_ID']; ?>" class="btn btn-block btn-xs btn-info">View</a></td>
                        </tr>
