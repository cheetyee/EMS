                    ...
                    <div class="panel-body">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control input-sm" name="phone_no" id="input" value="0<?php echo $employee['phone_no']?>" disabled>
                            </div>
                            </br>
                            <div class="form-group">
                                <label>Email </label>
                            ...
                            <div class="form-group">
                                <a href="editEmpProfile.php?emp_ID=<?php echo $employee['emp_ID']; ?>" class="btn btn-block btn-warning">Edit</a>
                            </div>
                            </br>
