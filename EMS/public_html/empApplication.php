            ...
            <div class="col-lg-9 col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading"><h4>Application</h4></div>
                        <a href="applyLeaves.php" style=" float:right;" class="btn btn-primary"><i class="fa fa-plus"></i> Apply Leaves</a>
                    </br></br>
                    ...
                    <table class="table table-bordered">
                        ...
                        $apply = "SELECT * FROM application WHERE emp_ID = '$emp_ID' AND type='leaves' ORDER BY status='Pending' DESC";
                        ...
                        <tr>
                            ...
                            <td><a href="empAppDetails.php?app_ID=<?php echo $application['app_ID']; ?>" class="btn btn-block btn-xs btn-info">View</a></td>
                        </tr>
